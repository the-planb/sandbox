...
use App\BookStore\Framework\Api\State\Processor\UpdateTagProcessor;
 ...
 * @internal
 */
class UpdateTagProcessorTest extends TestCase
{
    use BookStoreTrait;
    ...
    public function test_it_launchs_the_correct_command()
    {
        ...
        $commandBus->handle(Argument::type(UpdateTag::class))
            ->shouldBeCalledOnce()
        ;
        ...
        $processor = new UpdateTagProcessor($commandBus->reveal());
